    ...
    <div style="display: flex; justify-content: space-between; align-items:center">
        ...
        <nav aria-label="breadcrumb" style="padding-right: 5px">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a wire:navigate href="{{ route('brand') }}"
    ...
    <div class="card p-4">
        <div class="row g-3 mb-3 align-items-center">
            ...
            <div class="col-md-8" style="text-align: right">
                <button @click="$dispatch('create-product-brand-modal')" type="button" class="btn btn-sm btn-success"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <livewire:dashboard.product.brand.brand-form />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr wire:key='{{ $key }}'>
                        ...
                        <td style="display: flex; justify-content:center">
                            <div class="">
                                <button
                                    @click="$dispatch('product-brand-edit-modal', {id: {{ $productBrand->id }}})"
