    ...
    <div style="display: flex; justify-content: space-between; align-items:center">
        ...
        <nav aria-label="breadcrumb" style="padding-right: 5px">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a wire:navigate href="{{ route('customer-edit', $customer_id) }}" style="">create</a></li>
            </ol>
        </nav>
    </div>

    @livewire('dashboard.people.customer.form',['customer_id' => $customer_id])
