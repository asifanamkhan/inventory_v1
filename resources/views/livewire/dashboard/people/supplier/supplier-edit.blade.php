    ...
    <div style="display: flex; justify-content: space-between; align-items:center">
        ...
        <nav aria-label="breadcrumb" style="padding-right: 5px">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a wire:navigate href="{{ route('supplier-edit', $supplier_id) }}" style="">create</a></li>
            </ol>
        </nav>
    </div>

    @livewire('dashboard.people.supplier.form',['supplier_id' => $supplier_id])
