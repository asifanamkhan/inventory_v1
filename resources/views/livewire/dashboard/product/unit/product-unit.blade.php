    ...
    <div style="display: flex; justify-content: space-between; align-items:center">
        ...
        <nav aria-label="breadcrumb" style="padding-right: 5px">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a wire:navigate href="{{ route('unit') }}"
    ...
    <div class="card p-4">
        <div class="row g-3 mb-3 align-items-center">
            ...
            <div class="col-md-8" style="text-align: right">
                <button @click="$dispatch('create-product-unit-modal')" type="button" class="btn btn-sm btn-success"
        ...
        <div class="responsive-table">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    @foreach ($this->resultUnit as $key => $productBrand)
                    <tr wire:key='{{ $key }}'>
                        ...
                        <td style="display: flex; justify-content:center">
                            <div class="">
                                <button
                                    @click="$dispatch('product-unit-edit-modal', {id: {{ $productBrand->id }}})"
